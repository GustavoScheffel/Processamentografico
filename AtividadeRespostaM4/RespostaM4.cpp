...
// Criação dos sprites com as novas texturas
    Sprite sprite0("../src/AtividadeRespostaM4/layer07_Sky.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f),
        glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite1("../src/AtividadeRespostaM4/layer06_Rocks.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
        glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite2("../src/AtividadeRespostaM4/layer05_Hills.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
        glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite3("../src/AtividadeRespostaM4/layer04_Clouds.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
        glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite4("../src/AtividadeRespostaM4/layer03_Hills_Castle.png",
         glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
         glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite5("../src/AtividadeRespostaM4/layer02_Trees_rocks.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
        glm::vec2(WIDTH, HEIGHT), 0.0f);
    Sprite sprite6("../src/AtividadeRespostaM4/layer01_Ground.png", 
        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
        glm::vec2(WIDTH, HEIGHT), 0.0f);
...
// Vetor de sprites
    ...
    sprites.push_back(std::move(sprite0));
    sprites.push_back(std::move(sprite1));
    sprites.push_back(std::move(sprite2));
    sprites.push_back(std::move(sprite3));
    sprites.push_back(std::move(sprite4));
    sprites.push_back(std::move(sprite5));
    sprites.push_back(std::move(sprite6));
